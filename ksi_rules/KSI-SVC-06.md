...
PASS Advanced automated key management with rotation and governance controls (50%): PASS Automated key management infrastructure: 17 KMS keys (0 customer-managed, 17 AWS-managed).
