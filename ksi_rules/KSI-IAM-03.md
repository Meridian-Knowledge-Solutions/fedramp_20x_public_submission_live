...
WARNING Basic service authentication security (needs enhancement): FAIL No IAM roles found for service authentication
- PASS No access key information accessible
- PASS 1 EC2 instances using instance profiles
