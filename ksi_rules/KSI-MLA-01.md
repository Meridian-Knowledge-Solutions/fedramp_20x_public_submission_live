...
- PASS Centralized log collection: 23 log groups (20 AWS services, 3 applications)
...
- PASS Cryptographic infrastructure: 15 KMS keys available for log protection
