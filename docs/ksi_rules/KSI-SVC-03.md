...
PASS Advanced at-rest encryption across multiple storage services (40%): PASS Object storage encryption: 2 S3 buckets configured (encryption validation requires bucket-level check)
